# -*- coding: utf-8 -*-
"""
Created on Tue Mar 31 22:05:14 2020
...
from data import ModelNet40,ParisLille
from model import PointNet, PointNetPlus, DGCNN, MoNet, DGCNN_seg
import numpy as np
from torch.utils.data import DataLoader
from util import cal_loss, IOStream, loss_sem_seg
...
def train(args, io):
    ...
    #Try to load models
    if args.model == 'dgcnnseg':
        model = DGCNN_seg(args).to(device)
    else:
